...
The goal of p.post is to populate a spreadsheet with the number of successes required, given number of subjects \eqn{n} supplied, to satisfy conditions set for the posterior probability of the underlying success rate, p_post.  Thus, it ensures $P({\sf p\_post}>p_1)$, where: 
